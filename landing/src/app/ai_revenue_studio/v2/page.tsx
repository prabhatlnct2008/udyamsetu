...
const WHATSAPP_DIRECT = buildWhatsAppLink('Hi, I want to order the ₹99 website');
        ...
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-14">
          <div className="text-center">
            ...
            <p className="mt-3 text-base md:text-lg text-slate-600">
              Drop your WhatsApp number. We&apos;ll share a design preview in 2
              hours and ship your full site in 24. Pay only when it&apos;s live.
            </p>
          </div>
